...
import pranoti from "../assets/Contact/Pranoti.png"
import pratik from "../assets/Contact/Pratik.jpg"

function Contact() {
  let message = `Welcome to the Police Online Complaint Portal. We are committed to ensuring your safety and security by providing a reliable platform to report crimes and lodge complaints. Our dedicated team is here to assist you every step of the way, ensuring that your voice is heard and justice is served. Join us in our mission to create a safer community for everyone.`;
  return (
    <section className="section-white">
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center">
            <h2 className="section-title font-bold text-4xl">The Team Behind Police Online Complaint Portal</h2><br></br>
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item flex flex-col items-center">
              <img src={rushikesh} className="team-img" alt="pic" />
              <h3>Rushikesh</h3>
              <div className="team-info">
                ...
                <div className=" flex items-center gap-2 w-fit mx-auto my-5">
                  <div className="w-10 h-10">
                    <a
                      href="https://www.linkedin.com/in/rushikesh-ghuge-78ab0423b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                      target="_blank"
                  ...
                  <div className="w-10 h-10">
                    <a href="mailto:rushikeshghuge2019@gmail.com" target="_blank">
                      <svg
                        viewBox="0 0 32 32"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-10 h-10">
                    <a href="https://wa.me/9527025495" target="_blank">
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item flex flex-col items-center">
              <img src={pranoti} className="team-img h-36 w-52" alt="pic" />
              <h3>Pranoti Koshti</h3>
              <div className="team-info">
                ...
                <div className=" flex items-center gap-2 w-fit mx-auto my-5">
                  <div className="w-10 h-10">
                    <a
                      href="https://www.linkedin.com/in/pranoti-koshti-37587b193/"
                      target="_blank"
                      className="w-full h-full flex items-center justify-center"
                    >
                      <svg
                  ...
                  <div className="w-10 h-10">
                    <a href="mailto:pranotikoshti2904@gmail.com" target="_blank">
                      <svg
                        viewBox="0 0 32 32"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-10 h-10">
                    <a href="https://wa.me/9960984921" target="_blank">
                      <img src={WhatsApp} alt="" />
                    </a>
                  </div>
                </div>
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item flex flex-col items-center">
              <img src={aakanksha} className="team-img h-36 w-52" alt="pic" />
              <h3>Aakanksha Somankar</h3>
              <div className="team-info">
                <p className="font-semibold">001 Juhu</p>
                <p>As an entry-level full stack developer, Aakanksha is adept at building and maintaining full-stack web applications. Her skill set spans a range of technologies, allowing her to handle the complete development cycle.
                </p>
                ...
                <div className=" flex items-center gap-2 w-fit mx-auto my-5">
                  ...
                  <div className="w-10 h-10">
                    <a href="mailto:aakankshasomankar28@gmail.com" target="_blank">
                      <svg
                        viewBox="0 0 32 32"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-10 h-10">
                    <a href="https://wa.me/8605836913" target="_blank">
                      <img src={WhatsApp} alt="" />
                    </a>
                  </div>
                </div>
            ...
            <div className="team-item flex flex-col items-center">
              ...
              <div className="team-info">
                ...
                <div className=" flex items-center gap-2 w-fit mx-auto my-5">
                  ...
                  <div className="w-10 h-10">
                    <a href="mailto:pratikd0402@gmail.com" target="_blank">
                      <svg
                        viewBox="0 0 32 32"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="w-10 h-10">
                    <a href="https://wa.me/9922853917" target="_blank">
                      <img src={WhatsApp} alt="" />
                    </a>
                  </div>
                </div>
